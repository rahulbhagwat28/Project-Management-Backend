...
/*
Setting Up Spring security for security according to user roles
 */
@Configuration
@EnableWebSecurity
...
public class SecurityConfig {
    ...
    public SecurityFilterChain configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(auth -> auth.requestMatchers("/api/v1/employees/findAllEmployees","http://localhost:8080/v2/api-docs").permitAll())
